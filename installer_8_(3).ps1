...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
  ...
  <Window.Resources>
    ...
    <Style x:Key="ActionBtn" TargetType="Button">
      <Setter Property="Background" Value="#aa1e1e2e"/>
      <Setter Property="Foreground" Value="#a78bfa"/>
      <Setter Property="BorderThickness" Value="1"/>
      <Setter Property="BorderBrush" Value="#552a2a4a"/>
    ...
    <Style x:Key="WarpBtn" TargetType="Button">
      <Setter Property="Background" Value="#aa1a1a2e"/>
  ...
  <Grid>
    ...
    <Border Grid.Row="0" Grid.RowSpan="3" Background="#e00c0c11"/>

    <!-- ═══ HEADER ═══ -->
    <Border Grid.Row="0" Background="#cc0f0f18" Padding="18,14,18,12">
      <Grid>
        <Grid.RowDefinitions>
          <RowDefinition Height="Auto"/>
          <RowDefinition Height="Auto"/>
        ...
        <Grid Grid.Row="0">
          ...
          <StackPanel Grid.Column="1" VerticalAlignment="Center">
            <StackPanel Orientation="Horizontal">
              ...
              <TextBlock Text=" Tool Suite" FontSize="24" FontWeight="Light" Foreground="#44445a"/>
            </StackPanel>
            <TextBlock Foreground="#33334a" FontSize="11" Margin="0,2,0,0">
          ...
          <StackPanel Grid.Column="2" VerticalAlignment="Center" HorizontalAlignment="Right">
            <StackPanel Orientation="Horizontal" HorizontalAlignment="Right" Margin="0,0,0,6">
              <TextBlock x:Name="LangLabel" Text="Language:" Foreground="#44445a" FontSize="11" VerticalAlignment="Center" Margin="0,0,5,0"/>
        ...
        <!-- Quick Help panel -->
        <Border Grid.Row="1" Background="#aa12121a" CornerRadius="8" Padding="14,10" Margin="0,12,0,0">
          <StackPanel>
            <TextBlock x:Name="QHTitle" Foreground="#a78bfa" FontSize="11" FontWeight="Bold" Margin="0,0,0,8"/>
    ...
    <!-- ═══ FOOTER ═══ -->
    <Border Grid.Row="2" Background="#cc0f0f18" Padding="16,10">
      <Grid>
        ...
        <Button x:Name="QuitBtn" Grid.Column="3" Background="#880f0f18" Foreground="#33334a"
...
# Helper: create BitmapImage from byte array — must be called on UI thread
# Download bytes on background thread, then invoke this on Dispatcher
function New-BitmapFromBytes([byte[]]$bytes) {
    ...
    $bmp.EndInit()
    # Keep ms alive until after EndInit; BitmapCacheOption::OnLoad copies data so we can dispose after
    $ms.Dispose()
    return $bmp
}

# Download on background thread, create bitmap + update UI on dispatcher
$null = [System.Threading.Tasks.Task]::Run([System.Action]{
    [Net.ServicePointManager]::SecurityProtocol = [Net.SecurityProtocolType]::Tls12

    function Get-Bytes([string]$url) {
        # Try Invoke-WebRequest first (handles TLS/redirects better), fall back to WebClient
        try {
    ...
    # Server icon
    $iconBytes = Get-Bytes "https://cdn.discordapp.com/icons/1408201417834893385/f5c9265968b03ac3e554063df0aa1d03.png?size=256"
    if ($iconBytes -and $iconBytes.Length -gt 0) {
        $window.Dispatcher.Invoke([action]{
            try {
                $bmp = New-BitmapFromBytes $iconBytes
    ...
    # Splash background
    $splashBytes = Get-Bytes "https://cdn.discordapp.com/discovery-splashes/1408201417834893385/7d797088d8f69ba1895d66daee4f6ce7.jpg?size=512"
    if ($splashBytes -and $splashBytes.Length -gt 0) {
        $window.Dispatcher.Invoke([action]{
            try {
                $bmp = New-BitmapFromBytes $splashBytes
                $splashBg.Source = $bmp
            } catch {}
        })
    }
...
# ── Load server icon from Discord CDN — bytes on background thread, bitmap on UI thread ──
`$null = [System.Threading.Tasks.Task]::Run([System.Action]{
    [Net.ServicePointManager]::SecurityProtocol = [Net.SecurityProtocolType]::Tls12
    try {
        `$url = "https://cdn.discordapp.com/icons/1408201417834893385/f5c9265968b03ac3e554063df0aa1d03.png?size=256"
        `$bytes = `$null
        try {
            `$r = Invoke-WebRequest -Uri `$url -UseBasicParsing -TimeoutSec 15 `
