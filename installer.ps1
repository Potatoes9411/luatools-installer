...
$T = @{
    en = @{
        winTitle    = "Luatools Tool Suite  |  .gg/luatools"
...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
        ...
        Background="#060b10" FontFamily="Segoe UI" FontSize="13"
        ResizeMode="CanMinimize">
  <Window.Resources>
    <Style x:Key="Card" TargetType="Border">
      <Setter Property="Background" Value="#aa0a1220"/>
      ...
      <Style.Triggers>
        <Trigger Property="IsMouseOver" Value="True">
          <Setter Property="Background" Value="#cc0d1a2e"/>
        </Trigger>
      </Style.Triggers>
    </Style>
    ...
    <Style x:Key="ActionBtn" TargetType="Button">
      <Setter Property="Background" Value="#aa0d1a2a"/>
      <Setter Property="Foreground" Value="#3b9eff"/>
      <Setter Property="BorderThickness" Value="1"/>
      <Setter Property="BorderBrush" Value="#551a3a5a"/>
        ...
        <Setter.Value>
          <ControlTemplate TargetType="Button">
            ...
            <ControlTemplate.Triggers>
              <Trigger Property="IsMouseOver" Value="True">
                <Setter Property="Background" Value="#cc112244"/>
                <Setter Property="BorderBrush" Value="#3b9eff"/>
              </Trigger>
            </ControlTemplate.Triggers>
          </ControlTemplate>
        </Setter.Value>
    ...
    <Style x:Key="WarpBtn" TargetType="Button">
      <Setter Property="Background" Value="#aa0a1f0a"/>
      <Setter Property="Foreground" Value="#6bdc8a"/>
      <Setter Property="BorderThickness" Value="1"/>
      <Setter Property="BorderBrush" Value="#551a3a1a"/>
      <Setter Property="Padding" Value="10,6"/>
      <Setter Property="FontSize" Value="11"/>
      <Setter Property="FontWeight" Value="SemiBold"/>
      <Setter Property="Cursor" Value="Hand"/>
      <Setter Property="Template">
        <Setter.Value>
          <ControlTemplate TargetType="Button">
            ...
            <ControlTemplate.Triggers>
              <Trigger Property="IsMouseOver" Value="True">
                <Setter Property="Background" Value="#cc0d2a0d"/>
    ...
    <Style x:Key="LangBtn" TargetType="Button">
      <Setter Property="Background" Value="#880d1a2a"/>
      <Setter Property="Foreground" Value="#2d4a6e"/>
      <Setter Property="BorderThickness" Value="0"/>
    ...
    <Style x:Key="HelpRow" TargetType="Border">
      <Setter Property="Background" Value="#66080d14"/>
    ...
    <Style x:Key="HelpSub" TargetType="TextBlock">
      <Setter Property="Foreground" Value="#6b8aaa"/>
      <Setter Property="FontSize" Value="10"/>
      <Setter Property="TextWrapping" Value="Wrap"/>
  ...
  <Grid>
    ...
    <!-- Dark tint overlay -->
    <Border Grid.Row="0" Grid.RowSpan="3" Background="#dd060b10"/>

    <!-- ═══ HEADER ═══ -->
    <Border Grid.Row="0" Background="#cc080d14" Padding="18,14,18,12">
      <Grid>
        <Grid.RowDefinitions>
          <RowDefinition Height="Auto"/>
          <RowDefinition Height="Auto"/>
        ...
        <Grid Grid.Row="0">
          ...
          <Button x:Name="ServerIconBtn" Grid.Column="0" Width="52" Height="52" Padding="0" Cursor="Hand"
            ...
            <Button.Template>
              <ControlTemplate TargetType="Button">
                <Border CornerRadius="14" ClipToBounds="True" Background="#0d1117">
          ...
          <StackPanel Grid.Column="1" VerticalAlignment="Center">
            <StackPanel Orientation="Horizontal">
              <TextBlock Text="Luatools" FontSize="24" FontWeight="Bold" Foreground="#3b9eff"/>
              <TextBlock Text=" Tool Suite" FontSize="24" FontWeight="Light" Foreground="#2d4a6e"/>
            </StackPanel>
            <TextBlock Foreground="#1e3a5a" FontSize="11" Margin="0,2,0,0">
              <Run Text="discord.gg/luatools  ·  by Potatoes9411 + contributors"/>
            </TextBlock>
          </StackPanel>
          <!-- Lang + action buttons -->
          <StackPanel Grid.Column="2" VerticalAlignment="Center" HorizontalAlignment="Right">
            <StackPanel Orientation="Horizontal" HorizontalAlignment="Right" Margin="0,0,0,6">
              <TextBlock x:Name="LangLabel" Text="Language:" Foreground="#2d4a6e" FontSize="11" VerticalAlignment="Center" Margin="0,0,5,0"/>
        ...
        <!-- Quick Help panel -->
        <Border Grid.Row="1" Background="#aa0a1420" CornerRadius="8" Padding="14,10" Margin="0,12,0,0">
          <StackPanel>
            <TextBlock x:Name="QHTitle" Foreground="#3b9eff" FontSize="11" FontWeight="Bold" Margin="0,0,0,8"/>
    ...
    <ScrollViewer Grid.Row="1" VerticalScrollBarVisibility="Auto" HorizontalScrollBarVisibility="Disabled" Padding="8,0,8,0">
      <StackPanel>
        <TextBlock x:Name="SecInstall" Style="{StaticResource SectionLabel}"/>
        <UniformGrid Columns="2">
          <Button x:Name="Btn1" Style="{StaticResource CardBtn}">
            <Border Style="{StaticResource Card}" BorderBrush="#222a1a5a" BorderThickness="1">
              <Grid Margin="16,14,16,14">
                ...
                <Grid Grid.Row="0"><Grid.ColumnDefinitions><ColumnDefinition Width="*"/><ColumnDefinition Width="Auto"/></Grid.ColumnDefinitions>
                  <StackPanel Orientation="Horizontal">
                    <TextBlock Text="1" Foreground="#3b9eff" FontWeight="Bold" FontSize="15" Margin="0,0,6,0"/>
                    <TextBlock x:Name="C1Title" FontWeight="SemiBold" Foreground="#e2e2f0" FontSize="14" VerticalAlignment="Center"/>
                  </StackPanel>
                  <Border x:Name="Badge1" Grid.Column="1" CornerRadius="3" Padding="6,2" Background="#661a2a1a">
                    <TextBlock x:Name="BadgeText1" FontSize="10" FontWeight="SemiBold"/>
                  </Border>
                </Grid>
                <TextBlock Grid.Row="1" Foreground="#557799" FontSize="10" Margin="0,3,0,0" FontStyle="Italic">by Potatoes9411  |  Full install: SteamTools + Millennium + Luatools plugin</TextBlock>
                <TextBlock Grid.Row="2" Foreground="#4a6a88" FontSize="11" TextWrapping="Wrap" Margin="0,7,0,0">Installs everything you need from scratch. Automatically downloads and sets up SteamTools, Millennium (the plugin loader), and the Luatools plugin. Closes Steam, installs, then relaunches it.</TextBlock>
                <Border Grid.Row="3" Background="#660d1a2a" CornerRadius="4" Padding="8,5" Margin="0,8,0,0">
                  <TextBlock Foreground="#3b9eff" FontSize="10" TextWrapping="Wrap">👆  NEW USER? START HERE — if the Luatools plugin appears RED after installing, run this again or try Option 6.</TextBlock>
                </Border>
              </Grid>
            </Border>
          </Button>
          <Button x:Name="Btn2" Style="{StaticResource CardBtn}">
            <Border Style="{StaticResource Card}">
              <Grid Margin="16,14,16,14">
                ...
                <Grid Grid.Row="0"><Grid.ColumnDefinitions><ColumnDefinition Width="*"/><ColumnDefinition Width="Auto"/></Grid.ColumnDefinitions>
                  <StackPanel Orientation="Horizontal">
                    <TextBlock Text="2" Foreground="#3b9eff" FontWeight="Bold" FontSize="15" Margin="0,0,6,0"/>
                    <TextBlock x:Name="C2Title" FontWeight="SemiBold" Foreground="#e2e2f0" FontSize="14" VerticalAlignment="Center"/>
                  </StackPanel>
                  <Border x:Name="Badge2" Grid.Column="1" CornerRadius="3" Padding="6,2" Background="#662a1a1a">
                    <TextBlock x:Name="BadgeText2" FontSize="10" FontWeight="SemiBold"/>
                  </Border>
                </Grid>
                <TextBlock Grid.Row="1" Foreground="#557799" FontSize="10" Margin="0,3,0,0" FontStyle="Italic">by Potatoes9411  |  Alternative plugin — same install process as Option 1</TextBlock>
                <TextBlock Grid.Row="2" Foreground="#4a6a88" FontSize="11" TextWrapping="Wrap" Margin="0,7,0,0">Installs the steamtools-collection plugin instead of Luatools. Same full process — SteamTools + Millennium + the collection plugin. Use this if you specifically want steamtools-collection.</TextBlock>
                <Border Grid.Row="3" Background="#661a1010" CornerRadius="4" Padding="8,5" Margin="0,8,0,0">
        ...
        <TextBlock x:Name="SecFixes" Style="{StaticResource SectionLabel}"/>
        <UniformGrid Columns="2">
          <Button x:Name="Btn3" Style="{StaticResource CardBtn}">
            <Border Style="{StaticResource Card}">
              <Grid Margin="16,14,16,14">
                ...
                <Grid Grid.Row="0"><Grid.ColumnDefinitions><ColumnDefinition Width="*"/><ColumnDefinition Width="Auto"/></Grid.ColumnDefinitions>
                  <StackPanel Orientation="Horizontal">
                    <TextBlock Text="3" Foreground="#3b9eff" FontWeight="Bold" FontSize="15" Margin="0,0,6,0"/>
                    <TextBlock x:Name="C3Title" FontWeight="SemiBold" Foreground="#e2e2f0" FontSize="14" VerticalAlignment="Center"/>
                  </StackPanel>
                  <Border x:Name="Badge3" Grid.Column="1" CornerRadius="3" Padding="6,2" Background="#662a2a1a">
                    <TextBlock x:Name="BadgeText3" FontSize="10" FontWeight="SemiBold"/>
                  </Border>
                </Grid>
                <TextBlock Grid.Row="1" Foreground="#557799" FontSize="10" Margin="0,3,0,0" FontStyle="Italic">by waike (waike.dev)  |  Patches Spacetheme CSS</TextBlock>
                <TextBlock Grid.Row="2" Foreground="#4a6a88" FontSize="11" TextWrapping="Wrap" Margin="0,7,0,0">Some versions of Spacetheme show a big 'Remove piracy plugin' overlay blocking your Steam. This patches the CSS file directly to remove it. Steam will be closed during patching.</TextBlock>
                <Border Grid.Row="3" Background="#661a1a10" CornerRadius="4" Padding="8,5" Margin="0,8,0,0">
            ...
            <Border Style="{StaticResource Card}">
              <Grid Margin="16,14,16,14">
                ...
                <StackPanel Grid.Row="0" Orientation="Horizontal">
                  <TextBlock Text="4" Foreground="#3b9eff" FontWeight="Bold" FontSize="15" Margin="0,0,6,0"/>
                  <TextBlock x:Name="C4Title" FontWeight="SemiBold" Foreground="#e2e2f0" FontSize="14" VerticalAlignment="Center"/>
                </StackPanel>
                <TextBlock Grid.Row="1" Foreground="#557799" FontSize="10" Margin="0,3,0,0" FontStyle="Italic">by waike (waike.dev)  |  Fixes loginusers.vdf</TextBlock>
                <TextBlock Grid.Row="2" Foreground="#4a6a88" FontSize="11" TextWrapping="Wrap" Margin="0,7,0,0">SteamTools sometimes forces Steam into offline mode, causing it to spin on the loading screen forever. This sets WantsOfflineMode=0 in loginusers.vdf so Steam starts normally.</TextBlock>
                <Border Grid.Row="3" Background="#661a1010" CornerRadius="4" Padding="8,5" Margin="0,8,0,0">
          ...
          <Button x:Name="Btn6" Style="{StaticResource CardBtn}">
            <Border Style="{StaticResource Card}">
              <Grid Margin="16,14,16,14">
                <Grid.RowDefinitions><RowDefinition Height="Auto"/><RowDefinition Height="Auto"/><RowDefinition Height="Auto"/><RowDefinition Height="Auto"/></Grid.RowDefinitions>
                <StackPanel Grid.Row="0" Orientation="Horizontal">
                  <TextBlock Text="6" Foreground="#3b9eff" FontWeight="Bold" FontSize="15" Margin="0,0,6,0"/>
                  <TextBlock x:Name="C6Title" FontWeight="SemiBold" Foreground="#e2e2f0" FontSize="14" VerticalAlignment="Center"/>
                </StackPanel>
                <TextBlock Grid.Row="1" Foreground="#557799" FontSize="10" Margin="0,3,0,0" FontStyle="Italic">by waike (waike.dev)  |  Re-downloads DLLs, adds Defender exclusions</TextBlock>
                <TextBlock Grid.Row="2" Foreground="#4a6a88" FontSize="11" TextWrapping="Wrap" Margin="0,7,0,0">Re-downloads xinput1_4.dll and dwmapi.dll, adds Defender exclusions for Steam, runs the Luatools temp fixer, and reinstalls the Luatools plugin. Run as Administrator for best results.</TextBlock>
                <Border Grid.Row="3" Background="#661a1010" CornerRadius="4" Padding="8,5" Margin="0,8,0,0">
          ...
          <Button x:Name="Btn8" Style="{StaticResource CardBtn}">
            <Border Style="{StaticResource Card}">
              <Grid Margin="16,14,16,14">
                <Grid.RowDefinitions><RowDefinition Height="Auto"/><RowDefinition Height="Auto"/><RowDefinition Height="Auto"/><RowDefinition Height="Auto"/></Grid.RowDefinitions>
                <StackPanel Grid.Row="0" Orientation="Horizontal">
                  <TextBlock Text="8" Foreground="#3b9eff" FontWeight="Bold" FontSize="15" Margin="0,0,6,0"/>
                  <TextBlock x:Name="C8Title" FontWeight="SemiBold" Foreground="#e2e2f0" FontSize="14" VerticalAlignment="Center"/>
                </StackPanel>
                <TextBlock Grid.Row="1" Foreground="#557799" FontSize="10" Margin="0,3,0,0" FontStyle="Italic">Program by SelectivelyGood  |  Script by Peron  |  Installs CloudRedirect</TextBlock>
                <TextBlock Grid.Row="2" Foreground="#4a6a88" FontSize="11" TextWrapping="Wrap" Margin="0,7,0,0">Downloads CloudRedirectCLI and cloud_redirect.dll from GitHub, runs /stfixer to fix server routing, and installs the DLL into Steam. Also fixes Purchase Errors. If it still fails after running, use Cloudflare Warp or ProtonVPN.</TextBlock>
                <Border Grid.Row="3" Background="#66101a10" CornerRadius="4" Padding="8,5" Margin="0,8,0,0">
          ...
          <Button x:Name="Btn10" Style="{StaticResource CardBtn}">
            <Border Style="{StaticResource Card}">
              <Grid Margin="16,14,16,14">
                <Grid.RowDefinitions><RowDefinition Height="Auto"/><RowDefinition Height="Auto"/><RowDefinition Height="Auto"/><RowDefinition Height="Auto"/></Grid.RowDefinitions>
                <StackPanel Grid.Row="0" Orientation="Horizontal">
                  <TextBlock Text="10" Foreground="#3b9eff" FontWeight="Bold" FontSize="15" Margin="0,0,6,0"/>
                  <TextBlock x:Name="C10Title" FontWeight="SemiBold" Foreground="#e2e2f0" FontSize="14" VerticalAlignment="Center"/>
                </StackPanel>
                <TextBlock Grid.Row="1" Foreground="#557799" FontSize="10" Margin="0,3,0,0" FontStyle="Italic">by clem.la &amp; melly  |  Full clean reinstall</TextBlock>
                <TextBlock Grid.Row="2" Foreground="#4a6a88" FontSize="11" TextWrapping="Wrap" Margin="0,7,0,0">Full clean reinstall: removes conflicting DLLs, clears registry unlock flags, adds Defender exclusions, re-downloads fresh DLLs, reinstalls Millennium silently, then relaunches Steam.</TextBlock>
                <Border Grid.Row="3" Background="#661a1010" CornerRadius="4" Padding="8,5" Margin="0,8,0,0">
        ...
        <TextBlock x:Name="SecOther" Style="{StaticResource SectionLabel}"/>
        <UniformGrid Columns="2">
          <Button x:Name="Btn5" Style="{StaticResource CardBtn}">
            <Border Style="{StaticResource Card}">
              <Grid Margin="16,14,16,14">
                ...
                <StackPanel Grid.Row="0" Orientation="Horizontal">
                  <TextBlock Text="5" Foreground="#3b9eff" FontWeight="Bold" FontSize="15" Margin="0,0,6,0"/>
                  <TextBlock x:Name="C5Title" FontWeight="SemiBold" Foreground="#e2e2f0" FontSize="14" VerticalAlignment="Center"/>
                </StackPanel>
                <TextBlock Grid.Row="1" Foreground="#557799" FontSize="10" Margin="0,3,0,0" FontStyle="Italic">by Potatoes9411  |  Toggle-based — choose exactly what to remove</TextBlock>
                <TextBlock Grid.Row="2" Foreground="#4a6a88" FontSize="11" TextWrapping="Wrap" Margin="0,6,0,0">Lets you tick checkboxes for what to uninstall: Luatools plugin, SteamTools DLLs, Millennium files, Lua game files. Nothing is removed until you confirm.</TextBlock>
              </Grid>
            </Border>
          </Button>
          <Button x:Name="Btn7" Style="{StaticResource CardBtn}">
            <Border Style="{StaticResource Card}">
              <Grid Margin="16,14,16,14">
                <Grid.RowDefinitions><RowDefinition Height="Auto"/><RowDefinition Height="Auto"/><RowDefinition Height="Auto"/><RowDefinition Height="Auto"/></Grid.RowDefinitions>
                <StackPanel Grid.Row="0" Orientation="Horizontal">
                  <TextBlock Text="7" Foreground="#3b9eff" FontWeight="Bold" FontSize="15" Margin="0,0,6,0"/>
                  <TextBlock x:Name="C7Title" FontWeight="SemiBold" Foreground="#e2e2f0" FontSize="14" VerticalAlignment="Center"/>
                </StackPanel>
                <TextBlock Grid.Row="1" Foreground="#557799" FontSize="10" Margin="0,3,0,0" FontStyle="Italic">by Skyflare, modified by Potatoes9411  |  3 sources: GitHub Mirror, Morrenus, ManifestHub</TextBlock>
                <TextBlock Grid.Row="2" Foreground="#4a6a88" FontSize="11" TextWrapping="Wrap" Margin="0,7,0,0">When SteamTools servers are down, games show 'Manifest unavailable'. This downloads the .manifest files from GitHub Mirror first (no key needed), then falls back to Morrenus or ManifestHub if needed.</TextBlock>
                <Border Grid.Row="3" Background="#661a1a10" CornerRadius="4" Padding="8,5" Margin="0,8,0,0">
          ...
          <Button x:Name="Btn9" Style="{StaticResource CardBtn}">
            <Border Style="{StaticResource Card}">
              <Grid Margin="16,14,16,14">
                <Grid.RowDefinitions><RowDefinition Height="Auto"/><RowDefinition Height="Auto"/><RowDefinition Height="Auto"/><RowDefinition Height="Auto"/></Grid.RowDefinitions>
                <StackPanel Grid.Row="0" Orientation="Horizontal">
                  <TextBlock Text="9" Foreground="#3b9eff" FontWeight="Bold" FontSize="15" Margin="0,0,6,0"/>
                  <TextBlock x:Name="C9Title" FontWeight="SemiBold" Foreground="#e2e2f0" FontSize="14" VerticalAlignment="Center"/>
                </StackPanel>
                <TextBlock Grid.Row="1" Foreground="#557799" FontSize="10" Margin="0,3,0,0" FontStyle="Italic">App by SelectivelyGood  |  Script by Potatoes9411  |  Standalone GUI tool</TextBlock>
                <TextBlock Grid.Row="2" Foreground="#4a6a88" FontSize="11" TextWrapping="Wrap" Margin="0,7,0,0">Downloads and launches CloudRedirect — a standalone GUI app for diagnosing and fixing Steam server routing issues. Different from Option 8 (that's the CLI fixer; this is the full GUI app).</TextBlock>
                <Border Grid.Row="3" Background="#66101018" CornerRadius="4" Padding="8,5" Margin="0,8,0,0">
                  <TextBlock Foreground="#4a6a88" FontSize="10" TextWrapping="Wrap">ℹ  For advanced network troubleshooting. Try Option 8 first — it's usually enough.</TextBlock>
                </Border>
              </Grid>
            </Border>
          </Button>
          <Button x:Name="Btn11" Style="{StaticResource CardBtn}">
            <Border Style="{StaticResource Card}">
              <Grid Margin="16,14,16,14">
                <Grid.RowDefinitions><RowDefinition Height="Auto"/><RowDefinition Height="Auto"/><RowDefinition Height="Auto"/></Grid.RowDefinitions>
                <StackPanel Grid.Row="0" Orientation="Horizontal">
                  <TextBlock Text="11" Foreground="#3b9eff" FontWeight="Bold" FontSize="15" Margin="0,0,6,0"/>
                  <TextBlock x:Name="C11Title" FontWeight="SemiBold" Foreground="#e2e2f0" FontSize="14" VerticalAlignment="Center"/>
                </StackPanel>
                <TextBlock Grid.Row="1" Foreground="#557799" FontSize="10" Margin="0,3,0,0" FontStyle="Italic">by atom0s  |  Removes Steam DRM from game EXEs</TextBlock>
    ...
    <!-- ═══ FOOTER ═══ -->
    <Border Grid.Row="2" Background="#cc080d14" Padding="16,10">
      <Grid>
        ...
        <TextBlock Foreground="#0d2040" FontSize="10" VerticalAlignment="Center">
        ...
        <Button x:Name="QuitBtn" Grid.Column="3" Background="#88080d14" Foreground="#1a3050"
          ...
          <Button.Template>
            <ControlTemplate TargetType="Button">
              ...
              <ControlTemplate.Triggers>
                <Trigger Property="IsMouseOver" Value="True"><Setter Property="Background" Value="#cc0d1a2a"/><Setter Property="Foreground" Value="White"/></Trigger>
              </ControlTemplate.Triggers>
            </ControlTemplate>
          </Button.Template>
        </Button>
...
# ── Load server icon + splash background asynchronously ──────────────────────
...
$null = [System.Threading.Tasks.Task]::Run([System.Action]{
    try {
        ...
        # Server icon
        $iconBytes = $wc.DownloadData("https://cdn.discordapp.com/icons/1408201417834893385/f5c9265968b03ac3e554063df0aa1d03.png?size=256")
        $iconMs = [System.IO.MemoryStream]::new($iconBytes)
        $iconBmp = [System.Windows.Media.Imaging.BitmapImage]::new()
        $iconBmp.BeginInit(); $iconBmp.StreamSource = $iconMs
        $iconBmp.CacheOption = [System.Windows.Media.Imaging.BitmapCacheOption]::OnLoad
        $iconBmp.EndInit(); $iconBmp.Freeze()

        # Splash background
        $splashBytes = $wc.DownloadData("https://cdn.discordapp.com/discovery-splashes/1408201417834893385/7d797088d8f69ba1895d66daee4f6ce7.jpg?size=512")
        $splashMs = [System.IO.MemoryStream]::new($splashBytes)
        $splashBmp = [System.Windows.Media.Imaging.BitmapImage]::new()
        $splashBmp.BeginInit(); $splashBmp.StreamSource = $splashMs
        $splashBmp.CacheOption = [System.Windows.Media.Imaging.BitmapCacheOption]::OnLoad
        $splashBmp.DecodePixelWidth = 512
        $splashBmp.EndInit(); $splashBmp.Freeze()

        $window.Dispatcher.Invoke([action]{
            # Set splash background
            $splashBg.Source = $splashBmp

            # Set server icon via button Content
            ...
            $b.ClipToBounds = $true
            $b.Background = [System.Windows.Media.SolidColorBrush]([System.Windows.Media.Color]::FromRgb(0x0d,0x11,0x17))
            $b.Child = $img
            $iconBtn.Content = $b
        })
    } catch {}
})
$iconBtn.Add_Click({ try { Start-Process "https://discord.gg/luatools" } catch {} })
...
$window.FindName("DiscordBtn").Add_Click({ try { Start-Process "https://discord.gg/luatools" } catch {} })
$window.FindName("ScriptBtn").Add_Click({  try { Start-Process "https://potatoes-dev.com/scripts/scmp9guj7b" } catch {} })
$window.FindName("HelpBtn").Add_Click({    try { Start-Process "https://discord.gg/luatools" } catch {} })
...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
  ...
  <Window.Resources>
    <Style x:Key="ActionBtn" TargetType="Button">
      ...
      <Setter Property="Foreground" Value="#3b9eff"/>
      <Setter Property="BorderThickness" Value="1"/>
      <Setter Property="BorderBrush" Value="#1a3a5a"/>
      <Setter Property="Padding" Value="10,6"/>
      <Setter Property="FontSize" Value="11"/>
      <Setter Property="FontWeight" Value="SemiBold"/>
      <Setter Property="Cursor" Value="Hand"/>
          ...
          <ControlTemplate TargetType="Button">
            ...
            <ControlTemplate.Triggers>
              ...
              <Trigger Property="IsEnabled" Value="False">
                ...
                <Setter Property="Foreground" Value="#1a3050"/>
              </Trigger>
            </ControlTemplate.Triggers>
          </ControlTemplate>
        </Setter.Value>
    ...
    <Style x:Key="WarpBtn" TargetType="Button">
      <Setter Property="Background" Value="#0a1f0a"/>
      <Setter Property="Foreground" Value="#6bdc8a"/>
      <Setter Property="BorderThickness" Value="1"/>
      ...
      <Setter Property="Template">
        <Setter.Value>
          <ControlTemplate TargetType="Button">
            ...
            <ControlTemplate.Triggers>
              <Trigger Property="IsMouseOver" Value="True">
                <Setter Property="Background" Value="#0d2a0d"/>
                <Setter Property="BorderBrush" Value="#6bdc8a"/>
              </Trigger>
            </ControlTemplate.Triggers>
          </ControlTemplate>
      ...
      <Setter Property="Template">
        <Setter.Value>
          <ControlTemplate TargetType="Button">
            ...
            <ControlTemplate.Triggers>
              <Trigger Property="IsMouseOver" Value="True"><Setter Property="Background" Value="#3b9eff"/></Trigger>
              <Trigger Property="IsEnabled"   Value="False"><Setter Property="Background" Value="#0d1a2a"/><Setter Property="Foreground" Value="#1e3a5a"/></Trigger>
            </ControlTemplate.Triggers>
          </ControlTemplate>
        </Setter.Value>
      </Setter>
  ...
  <Grid>
    ...
    <!-- ═══ HEADER ═══ -->
    <Border Grid.Row="0" Background="#080d14" Padding="18,14,18,12">
      <Grid>
        <Grid.ColumnDefinitions><ColumnDefinition Width="Auto"/><ColumnDefinition Width="*"/><ColumnDefinition Width="Auto"/></Grid.ColumnDefinitions>
        <!-- Server icon loaded from Discord CDN -->
        <Border Grid.Column="0" Width="52" Height="52" CornerRadius="14" Background="#080d14" Margin="0,0,14,0" ClipToBounds="True">
          <Image x:Name="ServerIconImg" Stretch="UniformToFill" RenderOptions.BitmapScalingMode="HighQuality"/>
        </Border>
        <StackPanel Grid.Column="1" VerticalAlignment="Center">
          <StackPanel Orientation="Horizontal">
            <TextBlock Text="Luatools" FontSize="22" FontWeight="Bold" Foreground="#3b9eff"/>
            <TextBlock Text=" Installer" FontSize="22" FontWeight="Light" Foreground="#2d4a6e"/>
          </StackPanel>
          <TextBlock x:Name="SubTitle" Foreground="#1e3a5a" FontSize="11" Margin="0,2,0,0" TextWrapping="Wrap">Preparing...</TextBlock>
        </StackPanel>
        <StackPanel Grid.Column="2" VerticalAlignment="Center" HorizontalAlignment="Right">
    ...
    <Border Grid.Row="1" Background="#0a1420" Padding="18,10,18,10" x:Name="InfoPanel">
      <StackPanel>
        <TextBlock Foreground="#1e3a5a" FontSize="10" FontWeight="SemiBold" Margin="0,0,0,6">WHAT THIS INSTALLER DOES — IN ORDER</TextBlock>
        <UniformGrid Columns="2">
          <TextBlock Foreground="#2d4a6e" FontSize="11">① Closes Steam completely</TextBlock>
          <TextBlock Foreground="#2d4a6e" FontSize="11">② Installs SteamTools (xinput1_4.dll + dwmapi.dll)</TextBlock>
          <TextBlock Foreground="#2d4a6e" FontSize="11">③ Installs Millennium (plugin loader)</TextBlock>
          <TextBlock Foreground="#2d4a6e" FontSize="11" x:Name="StepPluginTxt">④ Installs the plugin</TextBlock>
          <TextBlock Foreground="#2d4a6e" FontSize="11">⑤ Enables plugin in Millennium config</TextBlock>
          <TextBlock Foreground="#2d4a6e" FontSize="11">⑥ Cleans up leftover files and relaunches Steam</TextBlock>
        </UniformGrid>
        <Border Background="#0d1a2a" CornerRadius="4" Padding="8,5" Margin="0,8,0,0">
          <TextBlock Foreground="#3b9eff" FontSize="10" TextWrapping="Wrap">
    ...
    <Border Grid.Row="2" Background="#0d1a2a" CornerRadius="0" Padding="18,12,18,12">
      <StackPanel>
        <TextBlock x:Name="StepLabel" Foreground="#c8d8e8" FontWeight="SemiBold" Margin="0,0,0,8" TextWrapping="Wrap">Starting...</TextBlock>
        <ProgressBar x:Name="ProgressBar" Height="8" Minimum="0" Maximum="100" Value="0"
                     Background="#0a1420" Foreground="#3b9eff" BorderThickness="0"/>
        <TextBlock x:Name="StepHint" Foreground="#1e3a5a" FontSize="10" Margin="0,5,0,0" TextWrapping="Wrap"/>
      </StackPanel>
    </Border>

    <!-- ═══ LOG BOX ═══ -->
    <Border Grid.Row="3" Background="#060b10" Padding="12,10">
    ...
    <Border Grid.Row="4" x:Name="ErrorPanel" Background="#1a0808" Padding="18,12" Visibility="Collapsed">
      <StackPanel>
        ...
        <TextBlock Foreground="#c8d8e8" FontSize="11" TextWrapping="Wrap" Margin="0,0,0,10">
        ...
        <TextBlock Foreground="#1e3a5a" FontSize="10" TextWrapping="Wrap">
    ...
    <!-- ═══ FOOTER ═══ -->
    <Border Grid.Row="5" Background="#080d14" Padding="16,10">
      <Grid>
...
# ── Load server icon from Discord CDN asynchronously ──────────────────────────
`$null = [System.Threading.Tasks.Task]::Run([System.Action]{
    try {
        ...
        `$bmp.EndInit()
        `$bmp.Freeze()
        `$window.Dispatcher.Invoke([action]{ `$serverIcon.Source = `$bmp })
    } catch {}
})
...
function GDone {
    `$window.Dispatcher.Invoke([action]{
        ...
        `$progressBar.Foreground = [System.Windows.Media.SolidColorBrush]([System.Windows.Media.Color]::FromRgb(0x3b,0x9e,0xff))
        `$closeBtn.IsEnabled     = `$true
    })
}
