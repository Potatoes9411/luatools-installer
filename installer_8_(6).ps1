...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
  ...
  <Grid>
    ...
    <Image x:Name="SplashBg" Grid.Row="0" Grid.RowSpan="3"
           Stretch="UniformToFill" Opacity="0.35"
           RenderOptions.BitmapScalingMode="HighQuality"
           HorizontalAlignment="Center" VerticalAlignment="Center"/>
    <!-- Dark purple tint overlay -->
    <Border Grid.Row="0" Grid.RowSpan="3" Background="#cc08040f"/>

    <!-- ═══ HEADER ═══ -->
    <Border Grid.Row="0" Background="#cc08040f" Padding="18,14,18,12">
      <Grid>
        <Grid.RowDefinitions>
          <RowDefinition Height="Auto"/>
          <RowDefinition Height="Auto"/>
    ...
    <!-- ═══ FOOTER ═══ -->
    <Border Grid.Row="2" Background="#cc08040f" Padding="16,10">
      <Grid>
