...
if (-not $Branch) {
    ...
    $statusData   = @{ p1=$plugStatus1; p2=$plugStatus2; sp=$spaceStatus }
...
$st = try { (Get-Content $StatusFile -Raw | ConvertFrom-Json) } catch { @{p1="[unknown]";p2="[unknown]";sp="[unknown]"} }
...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
  ...
  <Window.Resources>
    ...
    <Style x:Key="WarpBtn" TargetType="Button">
      ...
      <Setter Property="BorderThickness" Value="1"/>
      <Setter Property="BorderBrush" Value="#2a4a2a"/>
      <Setter Property="Padding" Value="10,6"/>
      <Setter Property="FontSize" Value="11"/>
      <Setter Property="FontWeight" Value="SemiBold"/>
      <Setter Property="Cursor" Value="Hand"/>
    ...
    <Style x:Key="LangBtn" TargetType="Button">
      <Setter Property="Background" Value="#1e1e2e"/>
      <Setter Property="Foreground" Value="#7c7ca8"/>
      <Setter Property="BorderThickness" Value="0"/>
      ...
      <Setter Property="Template">
        <Setter.Value>
          <ControlTemplate TargetType="Button">
            ...
            <ControlTemplate.Triggers>
              <Trigger Property="IsMouseOver" Value="True">
                <Setter Property="Background" Value="#2a2a3f"/>
                <Setter Property="Foreground" Value="#a78bfa"/>
              </Trigger>
            </ControlTemplate.Triggers>
          </ControlTemplate>
  ...
  <Grid>
    ...
    <Border Grid.Row="0" Background="#0f0f18" Padding="18,14,18,12">
      <Grid>
        ...
        <Grid Grid.Row="0">
          ...
          <!-- Logo icon (Luatools rocket + lua style) -->
          <Border Grid.Column="0" Width="46" Height="46" CornerRadius="10" Margin="0,0,14,0"
                  Background="#1a1a2e">
            <Grid>
              <Ellipse Width="34" Height="34" Fill="#2a1a4a"/>
              <TextBlock Text="🚀" FontSize="20" HorizontalAlignment="Center" VerticalAlignment="Center"/>
            </Grid>
          </Border>
          <StackPanel Grid.Column="1" VerticalAlignment="Center">
            <StackPanel Orientation="Horizontal">
              <TextBlock Text="Luatools" FontSize="24" FontWeight="Bold" Foreground="#a78bfa"/>
              <TextBlock Text=" Tool Suite" FontSize="24" FontWeight="Light" Foreground="#6b6b88"/>
            </StackPanel>
            <TextBlock Foreground="#44445a" FontSize="11" Margin="0,2,0,0">
              <Run Text="discord.gg/luatools"/>
              <Run Text="  ·  " Foreground="#22222e"/>
              <Run Text="by Potatoes9411 + contributors" Foreground="#33334a"/>
            </TextBlock>
          </StackPanel>
          <!-- Language + links top-right -->
          <StackPanel Grid.Column="2" VerticalAlignment="Center" HorizontalAlignment="Right">
            <StackPanel Orientation="Horizontal" HorizontalAlignment="Right" Margin="0,0,0,6">
              <TextBlock Text="🌐" Foreground="#44445a" FontSize="11" VerticalAlignment="Center" Margin="0,0,5,0"/>
              <Button x:Name="LangEN" Style="{StaticResource LangBtn}" Content="EN"/>
              <Button x:Name="LangES" Style="{StaticResource LangBtn}" Content="ES"/>
              <Button x:Name="LangPT" Style="{StaticResource LangBtn}" Content="PT"/>
            </StackPanel>
            <StackPanel Orientation="Horizontal" HorizontalAlignment="Right">
              <Button x:Name="WarpBtn" Style="{StaticResource WarpBtn}" Content="☁  Get Cloudflare Warp (fix internet errors)" Margin="0,0,6,0"/>
              <Button x:Name="ScriptBtn" Style="{StaticResource ActionBtn}" Content="📋  All-in-One Fix Script"/>
            </StackPanel>
          </StackPanel>
        </Grid>

        <!-- Help / Common Issues panel -->
        <Border Grid.Row="1" Background="#12121a" CornerRadius="8" Padding="14,10" Margin="0,12,0,0">
          <StackPanel>
            <TextBlock Foreground="#a78bfa" FontSize="11" FontWeight="Bold" Margin="0,0,0,8">
              ⚡  QUICK HELP — Having an issue? Find your problem below and click the option number.
            </TextBlock>
    ...
    <ScrollViewer Grid.Row="1" VerticalScrollBarVisibility="Auto" HorizontalScrollBarVisibility="Disabled" Padding="8,0,8,0">
      <StackPanel>
        ...
        <!-- INSTALL / UPDATE -->
        <TextBlock Style="{StaticResource SectionLabel}" Text="⬇  INSTALL / UPDATE  —  Start here if you're new or need to reinstall"/>
        <UniformGrid Columns="2" Margin="0,0,0,0">

          <!-- 1: Install Luatools -->
          <Button x:Name="Btn1" Style="{StaticResource CardBtn}">
            <Border Style="{StaticResource Card}" BorderBrush="#2a1a5a" BorderThickness="1">
              <Grid Margin="16,14,16,14">
                <Grid.RowDefinitions><RowDefinition Height="Auto"/><RowDefinition Height="Auto"/><RowDefinition Height="Auto"/><RowDefinition Height="Auto"/></Grid.RowDefinitions>
                <Grid Grid.Row="0">
                  <Grid.ColumnDefinitions><ColumnDefinition Width="*"/><ColumnDefinition Width="Auto"/></Grid.ColumnDefinitions>
                  <StackPanel Orientation="Horizontal">
                    <TextBlock Text="1" Foreground="#a78bfa" FontWeight="Bold" FontSize="15" Margin="0,0,6,0"/>
                    <TextBlock Text="Install Luatools Plugin" FontWeight="SemiBold" Foreground="#e2e2f0" FontSize="14" VerticalAlignment="Center"/>
                  </StackPanel>
                  <Border x:Name="Badge1" Grid.Column="1" CornerRadius="3" Padding="6,2" Background="#1a2a1a">
                    <TextBlock x:Name="BadgeText1" Text="checking..." Foreground="#6bdc8a" FontSize="10" FontWeight="SemiBold"/>
                  </Border>
                </Grid>
                <TextBlock Grid.Row="1" Foreground="#8888aa" FontSize="10" Margin="0,3,0,0" FontStyle="Italic">by Potatoes9411  |  Full install: SteamTools + Millennium + Luatools plugin</TextBlock>
                <TextBlock Grid.Row="2" Foreground="#6b6b88" FontSize="11" TextWrapping="Wrap" Margin="0,7,0,0">
                  Installs everything you need from scratch. Automatically downloads and sets up SteamTools, Millennium (the plugin loader), and the Luatools plugin. Closes Steam, installs, then relaunches it.
                </TextBlock>
                <Border Grid.Row="3" Background="#1a1228" CornerRadius="4" Padding="8,5" Margin="0,8,0,0">
                  <TextBlock Foreground="#a78bfa" FontSize="10" TextWrapping="Wrap">
                    👆  NEW USER? START HERE — if the Luatools plugin appears RED after installing, run this again or try Option 6.
                  </TextBlock>
                </Border>
              </Grid>
            </Border>
            ...
            <Border Style="{StaticResource Card}">
              <Grid Margin="16,14,16,14">
                ...
                <Grid Grid.Row="0">
                  <Grid.ColumnDefinitions><ColumnDefinition Width="*"/><ColumnDefinition Width="Auto"/></Grid.ColumnDefinitions>
                  <StackPanel Orientation="Horizontal">
                    <TextBlock Text="2" Foreground="#a78bfa" FontWeight="Bold" FontSize="15" Margin="0,0,6,0"/>
                    <TextBlock Text="Install steamtools-collection" FontWeight="SemiBold" Foreground="#e2e2f0" FontSize="14" VerticalAlignment="Center"/>
                  </StackPanel>
                  <Border x:Name="Badge2" Grid.Column="1" CornerRadius="3" Padding="6,2" Background="#2a1a1a">
                    <TextBlock x:Name="BadgeText2" Text="checking..." Foreground="#f87171" FontSize="10" FontWeight="SemiBold"/>
                  </Border>
                </Grid>
                <TextBlock Grid.Row="1" Foreground="#8888aa" FontSize="10" Margin="0,3,0,0" FontStyle="Italic">by Potatoes9411  |  Alternative plugin — same install process as Option 1</TextBlock>
                <TextBlock Grid.Row="2" Foreground="#6b6b88" FontSize="11" TextWrapping="Wrap" Margin="0,7,0,0">
                  Installs the steamtools-collection plugin instead of Luatools. Same full process — SteamTools + Millennium + the collection plugin. Use this if you specifically want steamtools-collection.
                </TextBlock>
                <Border Grid.Row="3" Background="#1a1010" CornerRadius="4" Padding="8,5" Margin="0,8,0,0">
                  <TextBlock Foreground="#f87171" FontSize="10" TextWrapping="Wrap">
                    ℹ  Only use this instead of Option 1 — not both. They serve the same purpose.
                  </TextBlock>
                </Border>
              </Grid>
            </Border>
        ...
        <!-- FIXES -->
        <TextBlock Style="{StaticResource SectionLabel}" Text="🔧  FIXES  —  Use these when something goes wrong after installing"/>
        <UniformGrid Columns="2">

          <!-- 3: Spacetheme Block Remover -->
            ...
            <Border Style="{StaticResource Card}">
              <Grid Margin="16,14,16,14">
                ...
                <Grid Grid.Row="0">
                  <Grid.ColumnDefinitions><ColumnDefinition Width="*"/><ColumnDefinition Width="Auto"/></Grid.ColumnDefinitions>
                  <StackPanel Orientation="Horizontal">
                    <TextBlock Text="3" Foreground="#a78bfa" FontWeight="Bold" FontSize="15" Margin="0,0,6,0"/>
                    <TextBlock Text="Spacetheme Block Remover" FontWeight="SemiBold" Foreground="#e2e2f0" FontSize="14" VerticalAlignment="Center"/>
                  </StackPanel>
                  <Border x:Name="Badge3" Grid.Column="1" CornerRadius="3" Padding="6,2" Background="#2a2a1a">
                    <TextBlock x:Name="BadgeText3" Text="checking..." Foreground="#f59e0b" FontSize="10" FontWeight="SemiBold"/>
                  </Border>
                </Grid>
                <TextBlock Grid.Row="1" Foreground="#8888aa" FontSize="10" Margin="0,3,0,0" FontStyle="Italic">by waike (waike.dev)  |  Patches Spacetheme CSS</TextBlock>
                <TextBlock Grid.Row="2" Foreground="#6b6b88" FontSize="11" TextWrapping="Wrap" Margin="0,7,0,0">
                  Some versions of Spacetheme show a big 'Remove piracy plugin' overlay blocking your Steam. This patches the CSS file directly to remove it. Steam will be closed during patching.
                </TextBlock>
                <Border Grid.Row="3" Background="#1a1a10" CornerRadius="4" Padding="8,5" Margin="0,8,0,0">
                  <TextBlock Foreground="#f59e0b" FontSize="10" TextWrapping="Wrap">
                    ℹ  Only needed if you see a yellow 'get a job loser' / 'remove piracy plugin' overlay on Steam.
                  </TextBlock>
                </Border>
              </Grid>
            </Border>
            ...
            <Border Style="{StaticResource Card}">
              <Grid Margin="16,14,16,14">
                ...
                <StackPanel Grid.Row="0" Orientation="Horizontal">
                  <TextBlock Text="4" Foreground="#a78bfa" FontWeight="Bold" FontSize="15" Margin="0,0,6,0"/>
                  <TextBlock Text="Steam Offline Fix" FontWeight="SemiBold" Foreground="#e2e2f0" FontSize="14" VerticalAlignment="Center"/>
                </StackPanel>
                <TextBlock Grid.Row="1" Foreground="#8888aa" FontSize="10" Margin="0,3,0,0" FontStyle="Italic">by waike (waike.dev)  |  Fixes loginusers.vdf</TextBlock>
                <TextBlock Grid.Row="2" Foreground="#6b6b88" FontSize="11" TextWrapping="Wrap" Margin="0,7,0,0">
                  SteamTools sometimes forces Steam into offline mode, causing it to spin on the loading screen forever. This sets WantsOfflineMode=0 in loginusers.vdf so Steam starts normally.
                </TextBlock>
                <Border Grid.Row="3" Background="#1a1010" CornerRadius="4" Padding="8,5" Margin="0,8,0,0">
                  <TextBlock Foreground="#f87171" FontSize="10" TextWrapping="Wrap">
                    ℹ  Use this if Steam loads forever and gets stuck on the spinning loading screen.
                  </TextBlock>
                </Border>
              </Grid>
            </Border>
          ...
          <Button x:Name="Btn6" Style="{StaticResource CardBtn}">
            <Border Style="{StaticResource Card}">
              <Grid Margin="16,14,16,14">
                <Grid.RowDefinitions><RowDefinition Height="Auto"/><RowDefinition Height="Auto"/><RowDefinition Height="Auto"/><RowDefinition Height="Auto"/></Grid.RowDefinitions>
                <StackPanel Grid.Row="0" Orientation="Horizontal">
                  <TextBlock Text="6" Foreground="#a78bfa" FontWeight="Bold" FontSize="15" Margin="0,0,6,0"/>
                  <TextBlock Text="Steam Bulk Fixer" FontWeight="SemiBold" Foreground="#e2e2f0" FontSize="14" VerticalAlignment="Center"/>
                </StackPanel>
                <TextBlock Grid.Row="1" Foreground="#8888aa" FontSize="10" Margin="0,3,0,0" FontStyle="Italic">by waike (waike.dev)  |  Re-downloads DLLs, adds Defender exclusions</TextBlock>
                <TextBlock Grid.Row="2" Foreground="#6b6b88" FontSize="11" TextWrapping="Wrap" Margin="0,7,0,0">
                  Re-downloads xinput1_4.dll and dwmapi.dll, adds Defender exclusions for Steam, runs the Luatools temp fixer, and reinstalls the Luatools plugin. Run as Administrator for best results.
                </TextBlock>
                <Border Grid.Row="3" Background="#1a1010" CornerRadius="4" Padding="8,5" Margin="0,8,0,0">
                  <TextBlock Foreground="#f87171" FontSize="10" TextWrapping="Wrap">
                    ℹ  Use this if SteamTools stopped working after a Steam update, or games aren't unlocking.
                  </TextBlock>
                </Border>
              </Grid>
            </Border>
          ...
          <Button x:Name="Btn8" Style="{StaticResource CardBtn}">
            <Border Style="{StaticResource Card}">
              <Grid Margin="16,14,16,14">
                <Grid.RowDefinitions><RowDefinition Height="Auto"/><RowDefinition Height="Auto"/><RowDefinition Height="Auto"/><RowDefinition Height="Auto"/></Grid.RowDefinitions>
                <StackPanel Grid.Row="0" Orientation="Horizontal">
                  <TextBlock Text="8" Foreground="#a78bfa" FontWeight="Bold" FontSize="15" Margin="0,0,6,0"/>
                  <TextBlock Text="No Internet Connection Fix" FontWeight="SemiBold" Foreground="#e2e2f0" FontSize="14" VerticalAlignment="Center"/>
                </StackPanel>
                <TextBlock Grid.Row="1" Foreground="#8888aa" FontSize="10" Margin="0,3,0,0" FontStyle="Italic">Program by SelectivelyGood  |  Script by Peron  |  Installs CloudRedirect</TextBlock>
                <TextBlock Grid.Row="2" Foreground="#6b6b88" FontSize="11" TextWrapping="Wrap" Margin="0,7,0,0">
                  Downloads CloudRedirectCLI and cloud_redirect.dll from GitHub, runs /stfixer to fix server routing, and installs the DLL into Steam. Also fixes Purchase Errors. If it still fails after running, use Cloudflare Warp or ProtonVPN.
                </TextBlock>
                <Border Grid.Row="3" Background="#101a10" CornerRadius="4" Padding="8,5" Margin="0,8,0,0">
                  <TextBlock Foreground="#6bdc8a" FontSize="10" TextWrapping="Wrap">
                    ℹ  Use if Steam shows 'No internet connection', content is still encrypted, or you get purchase errors.
                  </TextBlock>
                </Border>
              </Grid>
            </Border>
          ...
          <Button x:Name="Btn10" Style="{StaticResource CardBtn}">
            <Border Style="{StaticResource Card}">
              <Grid Margin="16,14,16,14">
                <Grid.RowDefinitions><RowDefinition Height="Auto"/><RowDefinition Height="Auto"/><RowDefinition Height="Auto"/><RowDefinition Height="Auto"/></Grid.RowDefinitions>
                <StackPanel Grid.Row="0" Orientation="Horizontal">
                  <TextBlock Text="10" Foreground="#a78bfa" FontWeight="Bold" FontSize="15" Margin="0,0,6,0"/>
                  <TextBlock Text="Millennium &amp; SteamTools Reinstaller" FontWeight="SemiBold" Foreground="#e2e2f0" FontSize="14" VerticalAlignment="Center"/>
                </StackPanel>
                <TextBlock Grid.Row="1" Foreground="#8888aa" FontSize="10" Margin="0,3,0,0" FontStyle="Italic">by clem.la &amp; melly  |  Full clean reinstall</TextBlock>
                <TextBlock Grid.Row="2" Foreground="#6b6b88" FontSize="11" TextWrapping="Wrap" Margin="0,7,0,0">
                  Full clean reinstall: removes conflicting DLLs, clears registry unlock flags, adds Defender exclusions, re-downloads fresh DLLs, reinstalls Millennium silently, then relaunches Steam.
                </TextBlock>
                <Border Grid.Row="3" Background="#1a1010" CornerRadius="4" Padding="8,5" Margin="0,8,0,0">
                  <TextBlock Foreground="#f87171" FontSize="10" TextWrapping="Wrap">
                    ℹ  Use if you're getting hardlink errors, a broken install, or Option 1 keeps failing.
                  </TextBlock>
                </Border>
              </Grid>
            </Border>
        ...
        <!-- OTHER TOOLS -->
        <TextBlock Style="{StaticResource SectionLabel}" Text="⚙  OTHER TOOLS  —  Advanced utilities and extras"/>
        <UniformGrid Columns="2">
          ...
          <Button x:Name="Btn5" Style="{StaticResource CardBtn}">
            <Border Style="{StaticResource Card}">
              <Grid Margin="16,14,16,14">
                ...
                <StackPanel Grid.Row="0" Orientation="Horizontal">
                  <TextBlock Text="5" Foreground="#a78bfa" FontWeight="Bold" FontSize="15" Margin="0,0,6,0"/>
                  <TextBlock Text="ST Uninstaller" FontWeight="SemiBold" Foreground="#e2e2f0" FontSize="14" VerticalAlignment="Center"/>
                </StackPanel>
                <TextBlock Grid.Row="1" Foreground="#8888aa" FontSize="10" Margin="0,3,0,0" FontStyle="Italic">by Potatoes9411  |  Toggle-based — choose exactly what to remove</TextBlock>
                <TextBlock Grid.Row="2" Foreground="#6b6b88" FontSize="11" TextWrapping="Wrap" Margin="0,6,0,0">
                  Lets you tick checkboxes for what to uninstall: Luatools plugin, SteamTools DLLs, Millennium files, Lua game files. Nothing is removed until you confirm. Optionally restart Steam at the end.
                </TextBlock>
              </Grid>
            </Border>
          </Button>

          <!-- 7: Manifest Downloader -->
          <Button x:Name="Btn7" Style="{StaticResource CardBtn}">
            <Border Style="{StaticResource Card}">
              <Grid Margin="16,14,16,14">
                <Grid.RowDefinitions><RowDefinition Height="Auto"/><RowDefinition Height="Auto"/><RowDefinition Height="Auto"/><RowDefinition Height="Auto"/></Grid.RowDefinitions>
                <StackPanel Grid.Row="0" Orientation="Horizontal">
                  <TextBlock Text="7" Foreground="#a78bfa" FontWeight="Bold" FontSize="15" Margin="0,0,6,0"/>
                  <TextBlock Text="Steam Manifest Downloader" FontWeight="SemiBold" Foreground="#e2e2f0" FontSize="14" VerticalAlignment="Center"/>
                </StackPanel>
                <TextBlock Grid.Row="1" Foreground="#8888aa" FontSize="10" Margin="0,3,0,0" FontStyle="Italic">by Skyflare, modified by Potatoes9411  |  3 sources: GitHub Mirror, Morrenus, ManifestHub</TextBlock>
                <TextBlock Grid.Row="2" Foreground="#6b6b88" FontSize="11" TextWrapping="Wrap" Margin="0,7,0,0">
                  When SteamTools servers are down, games show 'Manifest unavailable'. This downloads the .manifest files from GitHub Mirror first (no key needed), then falls back to Morrenus or ManifestHub if needed.
                </TextBlock>
                <Border Grid.Row="3" Background="#1a1a10" CornerRadius="4" Padding="8,5" Margin="0,8,0,0">
                  <TextBlock Foreground="#f59e0b" FontSize="10" TextWrapping="Wrap">
                    ℹ  Try GitHub Mirror first (free, no key). Only use Morrenus/ManifestHub if GitHub Mirror fails.
                  </TextBlock>
                </Border>
              </Grid>
            </Border>
          ...
          <Button x:Name="Btn9" Style="{StaticResource CardBtn}">
            <Border Style="{StaticResource Card}">
              <Grid Margin="16,14,16,14">
                <Grid.RowDefinitions><RowDefinition Height="Auto"/><RowDefinition Height="Auto"/><RowDefinition Height="Auto"/><RowDefinition Height="Auto"/></Grid.RowDefinitions>
                <StackPanel Grid.Row="0" Orientation="Horizontal">
                  <TextBlock Text="9" Foreground="#a78bfa" FontWeight="Bold" FontSize="15" Margin="0,0,6,0"/>
                  <TextBlock Text="CloudRedirect GUI Launcher" FontWeight="SemiBold" Foreground="#e2e2f0" FontSize="14" VerticalAlignment="Center"/>
                </StackPanel>
                <TextBlock Grid.Row="1" Foreground="#8888aa" FontSize="10" Margin="0,3,0,0" FontStyle="Italic">App by SelectivelyGood  |  Script by Potatoes9411  |  Standalone GUI tool</TextBlock>
                <TextBlock Grid.Row="2" Foreground="#6b6b88" FontSize="11" TextWrapping="Wrap" Margin="0,7,0,0">
                  Downloads and launches CloudRedirect — a standalone GUI app for diagnosing and fixing Steam server routing issues. Different from Option 8 (that's the CLI fixer; this is the full GUI app).
                </TextBlock>
                <Border Grid.Row="3" Background="#101018" CornerRadius="4" Padding="8,5" Margin="0,8,0,0">
                  <TextBlock Foreground="#6b6b88" FontSize="10" TextWrapping="Wrap">
                    ℹ  For advanced network troubleshooting. Try Option 8 first — it's usually enough.
                  </TextBlock>
                </Border>
              </Grid>
            </Border>
          ...
          <Button x:Name="Btn11" Style="{StaticResource CardBtn}">
            <Border Style="{StaticResource Card}">
              <Grid Margin="16,14,16,14">
                <Grid.RowDefinitions><RowDefinition Height="Auto"/><RowDefinition Height="Auto"/><RowDefinition Height="Auto"/></Grid.RowDefinitions>
                <StackPanel Grid.Row="0" Orientation="Horizontal">
                  <TextBlock Text="11" Foreground="#a78bfa" FontWeight="Bold" FontSize="15" Margin="0,0,6,0"/>
                  <TextBlock Text="Steamless Game Patcher" FontWeight="SemiBold" Foreground="#e2e2f0" FontSize="14" VerticalAlignment="Center"/>
                </StackPanel>
                <TextBlock Grid.Row="1" Foreground="#8888aa" FontSize="10" Margin="0,3,0,0" FontStyle="Italic">by atom0s  |  Removes Steam DRM from game EXEs</TextBlock>
                <TextBlock Grid.Row="2" Foreground="#6b6b88" FontSize="11" TextWrapping="Wrap" Margin="0,6,0,0">
                  Lists all your Lua-enabled games, auto-detects the main EXE, and strips Steam DRM using Steamless CLI. Let you browse for the EXE manually if auto-detection fails. Games show Ready/Not installed/Disabled badges.
                </TextBlock>
              </Grid>
            </Border>
          </Button>
    ...
    <Border Grid.Row="2" Background="#0f0f18" Padding="16,10">
      <Grid>
        ...
        <TextBlock Foreground="#2a2a3f" FontSize="10" VerticalAlignment="Center">
          <Run Text="Luatools Tool Suite  |  discord.gg/luatools  |  potatoes-dev.com  |  Potatoes9411 + contributors"/>
        </TextBlock>
        <Button x:Name="HelpBtn" Grid.Column="1" Content="❓  Get Help" Style="{StaticResource ActionBtn}" Margin="0"/>
        <Button x:Name="QuitBtn" Grid.Column="3" Content="Quit" Background="#1a1a26" Foreground="#44445a"
...
# ---- Badge helpers ----
$badge1 = $window.FindName("Badge1"); $bt1 = $window.FindName("BadgeText1")
$badge2 = $window.FindName("Badge2"); $bt2 = $window.FindName("BadgeText2")
$badge3 = $window.FindName("Badge3"); $bt3 = $window.FindName("BadgeText3")

function Set-Badge($border, $tb, $text) {
    $tb.Text = $text
    if ($text -eq "[installed]" -or $text -eq "[found]") {
        $border.Background = [System.Windows.Media.SolidColorBrush]([System.Windows.Media.Color]::FromRgb(0x1a,0x2a,0x1a))
        ...
        $border.Background = [System.Windows.Media.SolidColorBrush]([System.Windows.Media.Color]::FromRgb(0x2a,0x1a,0x1a))
        $tb.Foreground     = [System.Windows.Media.SolidColorBrush]([System.Windows.Media.Color]::FromRgb(0xf8,0x71,0x71))
    } else {
        $border.Background = [System.Windows.Media.SolidColorBrush]([System.Windows.Media.Color]::FromRgb(0x2a,0x2a,0x1a))
        $tb.Foreground     = [System.Windows.Media.SolidColorBrush]([System.Windows.Media.Color]::FromRgb(0xf5,0x9e,0x0b))
    }
}
Set-Badge $badge1 $bt1 $st.p1
Set-Badge $badge2 $bt2 $st.p2
Set-Badge $badge3 $bt3 $st.sp
...
# Language buttons — set lang then reopen
...
# Cloudflare Warp button — open browser
$window.FindName("WarpBtn").Add_Click({
    try { Start-Process "https://one.one.one.one/" } catch {}
})

# All-in-One Fix Script button
$window.FindName("ScriptBtn").Add_Click({
    try { Start-Process "https://potatoes-dev.com/scripts/scmp9guj7b" } catch {}
})

# Help / Discord button
$window.FindName("HelpBtn").Add_Click({
    try { Start-Process "https://discord.gg/luatools" } catch {}
})

$window.ShowDialog() | Out-Null
if ($chosen) { $chosen | Set-Content $ResultFile -Encoding UTF8 }
'@ | Set-Content $menuScript -Encoding UTF8
    ...
    while ($menuLoop) {
        ...
        $plugStatus2 = Get-PluginStatus "steamtools-collection"
        $spaceStatus = Get-SpacethemeStatus
        @{ p1=$plugStatus1; p2=$plugStatus2; sp=$spaceStatus } | ConvertTo-Json -Compress | Set-Content $statusFile -Encoding UTF8
        Remove-Item $menuResult -Force -ErrorAction SilentlyContinue
        ...
        switch ($menuChoice) {
            ...
            "LEN" { $script:ScriptLanguage = "en"; Log "OK" "Language set to English" }
            "LES" { $script:ScriptLanguage = "es"; Log "OK" "Language set to Español" }
            "LPT" { $script:ScriptLanguage = "pt"; Log "OK" "Language set to Português" }
...
[xml]$xaml = @"
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
        Title="Steam Offline Fix  |  .gg/luatools"
...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
  ...
  <Grid Margin="20">
    ...
    <StackPanel Grid.Row="0" Margin="0,0,0,14">
      ...
      <TextBlock Text="Toggle what you want to remove, then click Run. Nothing is deleted until you confirm.  |  by Potatoes9411" Foreground="#44445a" FontSize="11" Margin="0,3,0,0" TextWrapping="Wrap"/>
...
[xml]$xaml = @"
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
        Title="Steam Bulk Fixer  |  .gg/luatools"
    ...
    <Border Grid.Row="2" Background="#0f0f18" Padding="16,10">
      <Grid>
        ...
        <TextBlock Grid.Column="1" Foreground="#2a2a3f" FontSize="10" VerticalAlignment="Center" Margin="8,0">
          by Skyflare, modified by Potatoes9411  |  discord.gg/luatools
        </TextBlock>
  ...
  <Grid Margin="20">
    ...
    <StackPanel Grid.Row="0" Margin="0,0,0,10">
      ...
      <TextBlock Foreground="#44445a" FontSize="11" Margin="0,3,0,0">
        <Run Text="Program by SelectivelyGood  |  Script by Peron  |  discord.gg/luatools"/>
      </TextBlock>
    </StackPanel>
...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
  ...
  <Grid Margin="20">
    ...
    <StackPanel Grid.Row="0" Margin="0,0,0,10">
      ...
      <TextBlock Foreground="#44445a" FontSize="11" Margin="0,3,0,0">App by SelectivelyGood  |  Script by Potatoes9411  |  discord.gg/luatools</TextBlock>
    </StackPanel>
...
[xml]$xaml = @"
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
        Title="Millennium &amp; SteamTools Reinstaller  |  .gg/luatools"
  ...
  <Grid Margin="20">
    ...
    <StackPanel Grid.Row="0" Margin="0,0,0,10">
      ...
      <TextBlock Foreground="#44445a" FontSize="11" Margin="0,3,0,0">by clem.la &amp; melly  |  Full clean reinstall  |  discord.gg/luatools</TextBlock>
    </StackPanel>
...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
  ...
  <Grid>
    ...
    <Border Grid.Row="0" Background="#0f0f18" Padding="18,14,18,12">
      <Grid>
        <Grid.ColumnDefinitions><ColumnDefinition Width="Auto"/><ColumnDefinition Width="*"/><ColumnDefinition Width="Auto"/></Grid.ColumnDefinitions>
        <Border Grid.Column="0" Width="46" Height="46" CornerRadius="10" Background="#1a1a2e" Margin="0,0,14,0">
          <Grid>
            <Ellipse Width="34" Height="34" Fill="#2a1a4a"/>
            <TextBlock Text="🚀" FontSize="20" HorizontalAlignment="Center" VerticalAlignment="Center"/>
          </Grid>
        ...
        <StackPanel Grid.Column="1" VerticalAlignment="Center">
          <StackPanel Orientation="Horizontal">
            ...
            <TextBlock Text=" Installer" FontSize="22" FontWeight="Light" Foreground="#6b6b88"/>
          </StackPanel>
          <TextBlock x:Name="SubTitle" Foreground="#44445a" FontSize="11" Margin="0,2,0,0" TextWrapping="Wrap">Preparing...</TextBlock>
        </StackPanel>
        <StackPanel Grid.Column="2" VerticalAlignment="Center" HorizontalAlignment="Right">
          <Button x:Name="WarpBtn"   Style="{StaticResource WarpBtn}"   Content="☁  Get Cloudflare Warp" Margin="0,0,0,5"/>
          <Button x:Name="HelpBtn"   Style="{StaticResource ActionBtn}" Content="❓  Get Help (discord)" Margin="0,0,0,0"/>
        </StackPanel>
      </Grid>
    </Border>
    ...
    <Border Grid.Row="1" Background="#12121a" Padding="18,10,18,10" x:Name="InfoPanel">
      <StackPanel>
        <TextBlock Foreground="#44445a" FontSize="10" FontWeight="SemiBold" Margin="0,0,0,6">WHAT THIS INSTALLER DOES — IN ORDER</TextBlock>
        <UniformGrid Columns="2">
          <TextBlock Foreground="#6b6b88" FontSize="11">① Closes Steam completely</TextBlock>
          <TextBlock Foreground="#6b6b88" FontSize="11">② Installs SteamTools (xinput1_4.dll + dwmapi.dll)</TextBlock>
          <TextBlock Foreground="#6b6b88" FontSize="11">③ Installs Millennium (plugin loader)</TextBlock>
          <TextBlock Foreground="#6b6b88" FontSize="11" x:Name="StepPluginTxt">④ Installs the plugin</TextBlock>
          <TextBlock Foreground="#6b6b88" FontSize="11">⑤ Enables plugin in Millennium config</TextBlock>
          <TextBlock Foreground="#6b6b88" FontSize="11">⑥ Cleans up leftover files and relaunches Steam</TextBlock>
        </UniformGrid>
        <Border Background="#1a1228" CornerRadius="4" Padding="8,5" Margin="0,8,0,0">
          <TextBlock Foreground="#a78bfa" FontSize="10" TextWrapping="Wrap">
    ...
    <Border Grid.Row="2" Background="#16161f" CornerRadius="0" Padding="18,12,18,12">
      <StackPanel>
        ...
        <ProgressBar x:Name="ProgressBar" Height="8" Minimum="0" Maximum="100" Value="0"
                     Background="#1a1a26" Foreground="#a78bfa" BorderThickness="0"/>
        <TextBlock x:Name="StepHint" Foreground="#44445a" FontSize="10" Margin="0,5,0,0" TextWrapping="Wrap"/>
      </StackPanel>
    </Border>

    <!-- ═══ LOG BOX ═══ -->
    <Border Grid.Row="3" Background="#0e0e16" Padding="12,10">
    ...
    <Border Grid.Row="4" x:Name="ErrorPanel" Background="#1a0808" Padding="18,12" Visibility="Collapsed">
      <StackPanel>
        ...
        <TextBlock Foreground="#44445a" FontSize="10" TextWrapping="Wrap">
...
function GDone {
    `$window.Dispatcher.Invoke([action]{
        ...
        `$progressBar.Foreground = [System.Windows.Media.SolidColorBrush]([System.Windows.Media.Color]::FromRgb(0x6b,0xdc,0x8a))
        `$closeBtn.IsEnabled     = `$true
    })
}
